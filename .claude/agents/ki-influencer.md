...
7. **Text**: Caption in `stimme_ton`/`sprache`, 5–10 Nischen-Hashtags (die aus dem Trend-Check), Hook-Zeile, CTA. In `content/influencer/<datum>_<slug>.md` ablegen: Idee, Trend-Bezug + Quelle, verwendetes Modell/Preset, **Credits-Kosten**, Bild- und Video-Link.
